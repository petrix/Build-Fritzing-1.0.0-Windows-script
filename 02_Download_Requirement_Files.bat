...
echo 7-Zip
rem if not exist 7z2301-x64.exe DownloadFile https://nrg.bratan.ooo/_fd/7z2301-x64.exe 7z2301-x64.exe
if not exist 7zr.exe DownloadFile https://nrg.bratan.ooo/_fd/7zr.exe 7zr.exe
...
if not exist ngspice-42.tar.gz DownloadFile https://nrg.bratan.ooo/_fd/ngspice-42.tar.gz ngspice-42.tar.gz

if not exist ngspice-42_dll_64.7z DownloadFile https://nrg.bratan.ooo/_fd/ngspice-42_dll_64.7z ngspice-42_dll_64.7z
